...
- [[16-KV-Cache-04-关键问题]]
- [[07-Scheduler-04-关键问题]]（Q3 Retract）
- [[08-设计追问与框架对比]]（追问 9）
...
- [[08-SchedulePolicy-04-关键问题]]
- [[15-RadixAttention-04-关键问题]]
- [[07-用户故事与场景]]
...
- [[07-Scheduler-04-关键问题]]（Q4 PP/Overlap）
- [[08-SchedulePolicy-01-核心概念]]
- [[23-Distributed-04-关键问题]]

---

## 4. RadixCache 命中率低

**症状：** `sglang:cache_hit_rate` 长期 < 0.3；TTFT 无改善；`num_matched_prefix_tokens` 接近 0。

**优先检查**

- 指标：`sglang:cache_hit_rate`（7d P50）、`num_matched_prefix_tokens` 分布
...
- [[22-Disaggregation-04-关键问题]]
- [[27-model-gateway-02-源码走读]]
- [[07-用户故事与场景]]（故事 C）
- [[08-设计追问与框架对比]]（追问 1–2）
...
- accept rate < 0.5，draft forward 成本大于节省
...
- [[21-Speculative-04-关键问题]]
- [[07-用户故事与场景]]（故事 B）
- [[08-设计追问与框架对比]]（追问 10–12）
...
- [[20-Sampling-04-关键问题]]
- [[07-Scheduler-04-关键问题]]（grammar sync）
- [[31-Observability-04-关键问题]]
...
- [[32-CheckpointEngine-04-关键问题]]
- [[31-Observability-04-关键问题]]（Q4–Q5）
- [[08-设计追问与框架对比]]（追问 15）
