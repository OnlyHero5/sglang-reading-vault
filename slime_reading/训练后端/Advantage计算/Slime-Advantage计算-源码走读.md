...
```python
# 来源：slime/backends/megatron_utils/actor.py L440-L509
...
```python
# 来源：slime/backends/megatron_utils/model.py L384-L445
batch_keys = [
    "tokens",
    "loss_masks",
...
```python
# 来源：slime/backends/megatron_utils/loss.py L766-L828
if args.use_opd:
