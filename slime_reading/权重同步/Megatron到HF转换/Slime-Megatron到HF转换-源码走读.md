...
```python
# 来源：slime/backends/megatron_utils/hf_checkpoint_saver.py L45-L88
...
```python
# 来源：slime/backends/megatron_utils/hf_checkpoint_saver.py L90-L120
...
```python
# 来源：slime/backends/megatron_utils/megatron_to_hf/qwen2.py L5-L71
...
```python
# 来源：slime/backends/megatron_utils/update_weight/update_weight_from_disk.py L16-L91
...
源码入口：`tests/utils/test_hf_checkpoint_saver.py` L21-L133。
